...
CREATE TABLE IF NOT EXISTS "public"."free_usage" (
    ...
    "times" bigint DEFAULT '0'::bigint,
    "updated_time" "text"
);
ALTER TABLE "public"."free_usage" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."subscription" (
    "email" "text" NOT NULL,
    "client_id" "text",
    "subscription" "text" DEFAULT 'member'::"text",
    "start_time" timestamp with time zone DEFAULT "now"(),
    "end_time" timestamp with time zone,
    "log" "json" DEFAULT '{}'::"json",
    "type" "text",
    "points" bigint DEFAULT '10000'::bigint
);
ALTER TABLE "public"."subscription" OWNER TO "postgres";
ALTER TABLE ONLY "public"."employees"
    ADD CONSTRAINT "employees_pkey" PRIMARY KEY ("id");
ALTER TABLE ONLY "public"."free_usage"
    ADD CONSTRAINT "free_usage_pkey" PRIMARY KEY ("client_id");
...
GRANT ALL ON TABLE "public"."free_usage" TO "anon";
GRANT ALL ON TABLE "public"."free_usage" TO "authenticated";
GRANT ALL ON TABLE "public"."free_usage" TO "service_role";
