...
import { ArchiveIcon, Component1Icon, CubeIcon, EyeOpenIcon, FileIcon, FileTextIcon, MixIcon } from "@radix-ui/react-icons";
            ...
            <Container className="relative">
                ...
                <div
                    ...
                    >
                        ...
                        <p className="font-bold text-4xl mt-6">
                            <span
                                className="bg-gradient-to-tr from-cyan-950 to-emerald-200 text-transparent bg-clip-text">Vision </span> Chat
                        </p>
                        <p className="mt-6">
