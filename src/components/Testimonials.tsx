...
function QuoteIcon(props) {
  return (
    <svg aria-hidden="true" viewBox="0 0 105 78" width={105} height={78} {...props}>
  ...
  return (
    ...
    >
      <Container className={styles.sectionContainer}>
        ...
        <ul
          role="list"
          className={`${styles.cards} ${styles.quoteGrid} mx-auto mt-12 grid max-w-2xl grid-cols-1 lg:max-w-none lg:grid-cols-3`}
        >
              ...
              <ul role="list" className="flex flex-col gap-y-4">
                {column.map((testimonial, testimonialIndex) => (
                  <li key={testimonialIndex}>
                    <figure className={`${styles.card} relative`} data-spotlight data-reveal>
                      <QuoteIcon className="absolute left-6 top-6 fill-hairline" />
                      <blockquote className="relative">
                        <p className="text-lg tracking-tight text-content-body">
                          {testimonial.content}
                        </p>
                      </blockquote>
                      <figcaption className="relative mt-6 flex items-center justify-between border-t border-hairline pt-6">
                        <div>
                          <div className="font-display text-base text-content">
