...
export const features: Feature[] = [
    ...
    {
        title: 'Mini SmartBar',
        description: 'A persistent mini version of SmartBar that provides quick access to essential features like Speak and Live Screen, while displaying real-time status information. This compact desktop companion stays readily available across all applications.',
        icon: () => (
        ...
        gradient: 'from-purple-600 to-indigo-400',
        media: 'https://www.youtube.com/watch?v=fciluYZ9YvU',
        mediaType: 'youtube'
    },
    {
        title: 'MCP Store',
        description: 'A curated collection of popular MCP Servers with convenient features including one-click installation, online access at <a href="https://app.enconvo.ai/mcp_store" target="_blank" rel="noopener noreferrer">app.enconvo.ai/mcp_store</a>, and shareable links to easily share your favorite servers with friends.',
        icon: () => (
            // Store icon showing a collection/marketplace concept
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
        ...
        media: 'https://www.youtube.com/watch?v=W1_NvYPxQOY',
        mediaType: 'youtube'
    },
    {
        title: 'Agent Mode',
